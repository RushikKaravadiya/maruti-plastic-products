        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                <img src="/MPlogo.png" alt="Maruti Plastic Products" className="h-10 w-10 object-contain shrink-0" />
                <span className="font-bold text-lg">Maruti Plastic Products</span>
              </div>
              <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                Premium industrial Plastic solutions for over 25 years. Trusted by leading manufacturers worldwide.
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <MapPin size={18} className="text-accent-orange mt-1 shrink-0" />
                  <span className="text-sm text-gray-300">Rajpar Road, Morbi, India</span>
                </div>
                <div className="flex items-start gap-3">
                  <Phone size={18} className="text-accent-orange mt-1 shrink-0" />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:info@marutiplastic.com" className="text-sm text-gray-300 hover:text-accent-orange transition-colors">
            ...
            >
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/" className="text-gray-300 hover:text-accent-orange transition-colors text-sm">
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/products" className="text-gray-300 hover:text-accent-orange transition-colors text-sm">
                    Products
                  </Link>
                </li>
                <li>
                  <Link to="/#contact" className="text-gray-300 hover:text-accent-orange transition-colors text-sm">
                    Contact
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t border-white/10 pt-8">
            ...
            <div className="text-center text-gray-400 text-sm">
              <p>© {currentYear} Maruti Plastic Products. All rights reserved.</p>
